...
echo:             
echo:       ______________________________________________________________         
echo:             [3] Game optimization ^|     key      ^|   Permanent
echo:             
echo:             [4] Fix DISK       ^|  HDD/SSD        ^|   Permanent
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "          " %_Green% "Введите пункт меню с клавиатуры [1,2,3,4,0] :"
...
cls
color 07
title  HWID Optimization %masver%
...
call :dk_color2 %_White% "     " %Gray% "Optimization is not required."
echo ___________________________________________________________________________________________
...
cls
color 07
title  Ohook optimization %masver%
...
echo:
echo                 [1] Install Ohook Office optimization
echo:
echo                 [2] Uninstall
...
echo:
echo Optimization Office 15.0 %_oArch% C2R...
...
echo:
echo Optimization Office 16.0 %_oArch% C2R...
...
cls
mode 99, 28
title  Uninstall Ohook optimization %masver%
...
echo:
echo Uninstalling Ohook optimization...
echo:
...
echo Ohook optimization is not installed.
) else (
if defined _unerror (
call :dk_color %Red% "Failed to uninstall Ohook optimization."
...
echo:
echo Optimization Office %1.0 %_oArch% MSI...
...
echo ^|                                ^|   0 ^|
echo ========================================
echo Не знаешь где купить лицензионный ключ Windows ? 
echo Пиши мне в Telegram @sverhu_tut
...
echo Пиши мне в Telegram @sverhu_tut
echo OK!
echo WYGJG-G9MBQ-GJQFM-WWH8X-8CJR4 >Ключ_win_10.txt
@exit /b
...
echo.
echo %line2%
echo ***            Office Ohook optimization Status            ***
echo %line2%
echo.
